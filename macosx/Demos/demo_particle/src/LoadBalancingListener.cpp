...
LoadBalancingListener::LoadBalancingListener(BaseView* pView) : mpLbc(NULL), mpView(pView), mLocalPlayerNr(0), mGridSize(DEFAULT_GRID_SIZE), mMap(DEFAULT_MAP), mAutomove(true), mUseGroups(true), mSendGroup(0)
{
}
