...
#elif !defined _EG_WINDOWS_PLATFORM && !defined _EG_PSVITA_PLATFORM && !defined _EG_XB1_PLATFORM && !defined _EG_SWITCH_WINDOWS_PLATFORM
#	include <unistd.h>
#endif
...
int getcharIfKbhit(void)
{
	return 0; // no input handling implemented for PSVita yet
}
#elif defined _EG_XB1_PLATFORM
int getcharIfKbhit(void)
{
	return 0; // no input handling implemented for Xb1 yet
}
#elif defined _EG_SWITCH_PLATFORM
int getcharIfKbhit(void)
{
	return 0; // no input handling implemented for Switch yet
}
#else
#include <fcntl.h>
#include <termios.h>
...
#if !defined _EG_XB1_PLATFORM &&  !_EG_SWITCH_PLATFORM
